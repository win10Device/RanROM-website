...
?>
	...
	<div id="main">
		...
		<div id="meminfo" class="box">
			<div>
				...
				(<span id="mem-cached" class="value"><?php echo $mem['cached']; ?></span> <?php echo $mem_multiple; ?> cached) (dedicated)
		...
		<div id="software" class="box">
			<ul>
				...
				<li>CPU (Shared): <span class="value"><?php echo $cpu_model; ?></span></li>
			</ul>
		</div>
	...
	<script src="../assets/vendor/js/jquery-3.4.1.min.js" type="text/javascript"></script>
