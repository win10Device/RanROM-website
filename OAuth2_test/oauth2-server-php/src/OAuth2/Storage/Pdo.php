    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    {
        $stmt = $this->db->prepare(sprintf('SELECT * from %s where OAuth_client_id = :client_id', $this->config['client_table']));
        ...
        return $result && password_verify($client_secret, $result['password']);
    }
    ...
    public function setClientDetails($client_id, $client_secret = null, $redirect_uri = null, $grant_types = null, $scope = null, $user_id = null)
    {
        ...
        if ($this->getClientDetails($client_id)) {
            $stmt = $this->db->prepare($sql = sprintf('UPDATE %s SET OAuth_client-secret=:client_secret, redirect_uri=:redirect_uri, grant_types=:OAuth_grant-types, scope=:scope, user_id=:OAuth_user-id where client_id=:OAuth_client-id', $this->config['client_table']));
        } else {
