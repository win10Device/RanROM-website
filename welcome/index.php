...
<main role="main">
    ...
    <section class="jumbotron text-center py-5">
		...
		<h1 class="jumbotron-heading mb-4"><?php echo APP_NAME; ?> </h1>
                   
	</a>
            <!h1 class="jumbotron-heading mb-4"><!PHP Login System</h1>
            <p class="text-muted">
               A personal project for testing and hosting all things web related. Containing network of machines hosting web servers, files, programs and game servers
